    ...
    */
    ...
    public void handle(Button button)
    {
        ...
        */
		...
		keyErrorText.setText("ERROR: The message and key aren't the right pair.");
		keyErrorText.setText("ERROR: This key doesn't belong to the message.");
		keyErrorText.setText("ERROR: The message, key, or both, are mismatched.");
            }
