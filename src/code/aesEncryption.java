...
public class aesEncryption
{
    ...
    public String aesEncrypt(String plaintext)
    {
        try {
            ...
            eCipherTextBytes = aesEncryptionCipher.doFinal(plaintext.getBytes("UTF-8"));
                //encodedCiphertext = Base64.getEncoder().encode(aesEncryptionCipher.doFinal(plaintext.getBytes("UTF-8")));
     ...
     * @param aesKey this is received from the sender. It's in the form of a SecretKey. This is the AES key in byte form.
     * @param cipherTextString this is the IV and message in encrypted form as a string. It is received in the key from the sender.
...
//**************************************RETURNING DECRYPTED STRING******************************************************
    ...
    {
        //Transmit the key's bytes using encoding (only way to transfer byte data)
    ...
    public String getIV()
    {
        //Transmit the IV's bytes using encoding (only way to transfer byte data)
    ...
    {
        //Nano Seconds: double eTotalTime = (eEndTime - eStartTime)/1000000000;
